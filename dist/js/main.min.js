    ...
    (s.prototype.getCanvasSize = function () {
      ...
      (s.prototype.randomise = function () {
        (this.colors = [
          ...
          (this.posX = 0),
          (this.posY = 0),
          (this.movementX = this.generateDecimalBetween(-10, 20) / this.velocity),
          (this.movementY = this.generateDecimalBetween(-10, 20) / this.velocity),
          (this.translateX = this.generateDecimalBetween(0, this.canvasWidth)),
          (this.translateY = this.generateDecimalBetween(this.canvasHeight + 100, this.canvasHeight + 300));
      });
    let a = function (t) {
